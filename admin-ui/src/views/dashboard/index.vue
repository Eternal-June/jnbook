    ...
    <el-row :gutter="40" class="panel-group">
      ...
      <el-col :xs="12" :sm="12" :lg="6" class="card-panel-col">
        <div class="card-panel" @click="handleSetLineChartData('messages')">
          ...
          <div class="card-panel-description">
            <div class="card-panel-text">书籍数量</div>
            <count-to :start-val="0" :end-val="booksTotal" :duration="3000" class="card-panel-num"/>
          </div>
        </div>
      </el-col>
      <el-col :xs="12" :sm="12" :lg="6" class="card-panel-col">
        <div class="card-panel" @click="handleSetLineChartData('purchases')">
          ...
          <div class="card-panel-description">
            <div class="card-panel-text">书籍库存</div>
...
export default {
  ...
  created() {
    info().then(response => {
      ...
      this.booksTotal = response.data.data.booksTotal
