    ...
    <el-dialog :visible.sync="orderDialogVisible" title="订单详情" width="800">
      ...
      <el-form :data="orderDetail" label-position="left">
        ...
        <el-form-item label="书籍信息">
          <el-table :data="orderDetail.orderBooks" size="small" border fit highlight-current-row>
            <el-table-column align="center" label="书籍名称" prop="booksName" />
        ...
        <el-form-item label="费用信息">
          <span>
            ...
            (书籍总价){{ orderDetail.order.booksPrice }}元 +
