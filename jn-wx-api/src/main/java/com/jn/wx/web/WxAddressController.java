...
import com.jn.wx.service.GetRegionService;
...
public class WxAddressController extends GetRegionService {
    ...
    public Object list(@LoginUser Integer userId) {
        ...
        List<JnAddress> addressList = addressService.queryByUid(userId);
        List<Map<String, Object>> addressVoList = new ArrayList<>(addressList.size());
        List<JnRegion> regionList = getJnRegions();
    ...
    public Object detail(@LoginUser Integer userId, @NotNull Integer id) {
        ...
        JnAddress address = addressService.findById(id);
        if (address == null) {
    ...
    private Object validate(JnAddress address) {
     ...
     */
    @PostMapping("save")
    public Object save(@LoginUser Integer userId, @RequestBody JnAddress address) {
     ...
     */
    @PostMapping("delete")
    public Object delete(@LoginUser Integer userId, @RequestBody JnAddress address) {
