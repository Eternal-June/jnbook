...
import static com.jn.wx.util.WxResponseCode.AUTH_CAPTCHA_UNMATCH;
import static com.jn.wx.util.WxResponseCode.APPLY_WITHDRAWAL_FAIL;
...
import com.jn.core.type.BrokerageTypeEnum;
...
public class WxBrokerageController {
	...
	public Object applyWithdrawal(@LoginUser Integer userId, @RequestBody String body) {
		...
		List<JnAccountTrace> traceList = accountService.getAccountTraceList(userId,BrokerageTypeEnum.SYS_APPLY.getType(),BrokerageTypeEnum.USER_APPLY.getType());
		if (traceList.size() > 0 ) {
