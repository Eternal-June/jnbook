...
public class WxCatalogController {
	...
	public Object index(Integer id) {
		...
		// 当前一级分类目录
		JnCategory currentCategory = null;
		if (id != null) {
		...
		// 当前一级分类目录对应的二级分类目录
		List<JnCategory> currentSubCategory = null;
	...
	public Object queryAll() {
		...
		// 所有子分类列表
		Map<Integer, List<JnCategory>> allList = new HashMap<>();
		List<JnCategory> sub;
		...
		// 当前一级分类目录
		JnCategory currentCategory = l1CatList.get(0);
	...
	public Object current(@NotNull Integer id) {
		...
		// 当前分类
		JnCategory currentCategory = categoryService.findById(id);
		List<JnCategory> currentSubCategory = categoryService.queryByPid(currentCategory.getId());
