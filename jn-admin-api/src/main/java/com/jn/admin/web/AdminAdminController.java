...
import static com.jn.admin.util.AdminResponseCode.ADMIN_INVALID_NAME;
import static com.jn.admin.util.AdminResponseCode.ADMIN_INVALID_PASSWORD;
import static com.jn.admin.util.AdminResponseCode.ADMIN_NAME_EXIST;
...
public class AdminAdminController {
	...
	public Object list(String username, @RequestParam(defaultValue = "1") Integer page,
		...
		List<JnAdmin> adminList = adminService.querySelective(username, page, limit, sort, order);
	...
	private Object validate(JnAdmin admin) {
	...
	@PostMapping("/create")
	public Object create(@RequestBody JnAdmin admin) {
	...
	public Object read(@NotNull Integer id) {
		...
		JnAdmin admin = adminService.findById(id);
	...
	@PostMapping("/update")
	public Object update(@RequestBody JnAdmin admin) {
	...
	@PostMapping("/delete")
	public Object delete(@RequestBody JnAdmin admin) {
