...
import static com.jn.admin.util.AdminResponseCode.ARTICLE_NAME_EXIST;
...
import com.jn.admin.util.ArticleType;
...
import com.jn.db.service.JnArticleService;
...
public class AdminArticleController {
    ...
    public Object list(String title, @RequestParam(defaultValue = "1") Integer page,
        ...
        List<JnArticle> articleList = articleService.querySelective(title, page, limit, sort, order);
    ...
    @PostMapping("/update")
    public Object update(@RequestBody JnArticle article) {
    ...
    @PostMapping("/delete")
    public Object delete(@RequestBody JnArticle article) {
    ...
    @PostMapping("/create")
    public Object create(@RequestBody JnArticle article) {
    ...
    private Object validate(JnArticle article) {
        String title = article.getTitle();
