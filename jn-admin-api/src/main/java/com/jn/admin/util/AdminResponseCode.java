...
//    ADMIN_DELETE_NOT_ALLOWED(604, ""),
    ...
    ADMIN_INVALID_AUTH(607, "认证失败"), BOOKS_UPDATE_NOT_ALLOWED(610, "书籍已经在订单或购物车中，不能修改"),
    BOOKS_NAME_EXIST(611, "书籍名已经存在"), ORDER_CONFIRM_NOT_ALLOWED(620, "当前订单状态不能确认收货"),
    ORDER_REFUND_FAILED(621, "当前订单状态不能退款"), ORDER_REPLY_EXIST(622, "订单书籍已回复！"),
    ADMIN_INVALID_OLD_PASSWORD(623, "原始密码不正确！"),ORDER_REPLY_FAIL(624, "订单书籍回复失败！"),
